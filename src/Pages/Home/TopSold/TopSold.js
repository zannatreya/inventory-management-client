      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center  gap-5">
        ...
        <article>
          ...
          >
            <SwiperSlide>
              <img
                className="hover:scale-110 h-full w-full duration-300 ease-in-out"
                src={car1}
                alt=""
              />
            </SwiperSlide>
        ...
        <article className="md:text-left">
          <h1 className="text-2xl text-white md:text-5xl font-bold">
            Most <span className="text-cyan-500">Popular</span> Car
          </h1>
          <p className=" text-white font-thin opacity-70 mt-5">
            The top sold car is here. You can import more.
            <br />
            This car becomes most popular now a day.
          </p>
          <div>
            <div className="py-5 mx-auto">
              <div className="flex justify-center text-white md:justify-start gap-8">
