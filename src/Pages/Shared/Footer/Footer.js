        ...
        <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            ...
            <div className="sm:col-span-2">
              <Link to="/">
                <p className="text-2xl text-white">
                  Books<span className="text-cyan-500">Portal</span>
                </p>
              </Link>
              <div className="mt-6 lg:max-w-sm text-white opacity-70 font-light">
                <p className="text-sm">
                  AutoMent is Car Dealer Company, Successfully running business
                  from 1995.
                </p>
          ...
          <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
            <p className="text-sm text-gray-600">
              © Copyright 2023 AutoMent. All rights reserved.
            </p>
